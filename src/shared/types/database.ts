    ...
    Tables: {
      ...
      avatar_assets: {
        Row: AuditColumns & {
          ...
          provider: "noop" | "local" | "s3" | "cloudflare_r2" | "railway_volume" | "railway_s3";
          storage_key: string;
          public_url: string | null;
          thumbnail_256_url: string | null;
          thumbnail_512_url: string | null;
          mime_type: string;
          size_bytes: number;
          width: number;
          height: number;
      ...
      file_assets: {
        Row: AuditColumns & {
          company_id: string | null;
          auth_user_id: string | null;
          provider: "railway_s3" | "s3" | "cloudflare_r2";
          bucket: string;
          object_key: string;
          original_file_name: string | null;
          mime_type: string;
      ...
      contracts: {
        Row: AuditColumns & {
          ...
          base_price_reference: number;
          discount_percent: number;
          payment_method: string;
          installments_count: number;
          installment_due_days: number[];
          payment_terms: Json;
          included_users: number;
          additional_users: number;
          additional_user_amount: number;
          hosted_by_automy: boolean;
          ...
          product_terms_snapshot: Json;
          negotiated_terms_snapshot: Json;
          product_contract_template_snapshot: string | null;
          contract_snapshot: Json;
          last_pdf_generated_at: string | null;
          signature_status: "draft" | "sent" | "signed" | "cancelled";
          signature_provider: string | null;
          signed_document_path: string | null;
          signed_at: string | null;
          notes: string | null;
          negotiated_terms: Json;
