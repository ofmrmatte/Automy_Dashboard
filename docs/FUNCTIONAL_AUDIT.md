...
| Configuracoes | Notificacoes                          | FUNCIONAL/PARCIAL | media      | usuario/admin                 | preferencias e centro in-app reais; envio de e-mail depende provider                 | eventos de negocio           | gerar notificacoes pelos modulos              |
